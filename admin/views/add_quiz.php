            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quiz Adding Section</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="post">
                                    ...
                                    <input type="button" class="btn btn-primary" id="btnAddQuiz" value="Add Quiz" /> 
                                </form>
